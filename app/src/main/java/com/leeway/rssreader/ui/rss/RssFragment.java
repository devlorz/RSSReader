...
/**
 * Created by Lee Lorz on 2/16/2017.
 */

public class RssFragment extends BaseFragment<RssPresenter> implements RssContract.View
    ...
    @Override
    public void onRssItemLoaded(List<RssItem> rssItems) {
